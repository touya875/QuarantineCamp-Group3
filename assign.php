        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-sm-4 mb-3">
					<div class="mr-auto">
						<h2 class="text-black font-w600">Assign</h2>
						<p class="mb-0">Assign Patients</p>
					</div>
					<!-- <div>
						<a href="javascript:void(0)" class="btn btn-primary mr-3" data-toggle="modal" data-target="#addOrderModal">+Assign</a>
							...
							<table id="example5" class="display dataTablesCard table-responsive-xl">
								...
								<tbody>
									<tr>
										...
										<td><span class="text-nowrap">#</span></td>
										<td><span class="text-nowrap">#P-00010</span></td>
										<td><span class="badge light badge-danger">Negative</span></td>
										<td>26/02/2020</td>
										<td>12:42 AM</td>
										<td>10/01/2020</td>
										<td><a href="javascript:void(0);"><strong>85 Nguyen Van Cu</a></strong></td>
										<td>
									...
									<tr>
										...
										<td>02:45 AM</td>
										<td>08/02/2019</td>
										<td><a href="javascript:void(0);"><strong>48 Tran Hung Dao</a></strong></td>
										<td>
											<div class="dropdown ml-auto text-right">
												<div class="btn-link" data-toggle="dropdown">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<tr>
										...
										<td><span class="text-nowrap">#</span></td>
										<td><span class="text-nowrap">#P-00028</span></td>
										<td><span class="text-nowrap">#</span></td>
										<td><span class="badge light badge-success">Positive</span></td>
										<td>26/02/2022</td>
										<td>01:40 AM</td>
										<td>28/02/2021</td>
										<td><a href="javascript:void(0);"><strong>23 Nguyen Trai</a></strong></td>
										<td>
											<div class="dropdown ml-auto text-right">
												<div class="btn-link" data-toggle="dropdown">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
