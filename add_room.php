<?php
    ...
    switch ($_GET['status']) {
        case "add":
            $sql = "INSERT INTO `assign`(`patient_id`, `staff_id`, `room`, `date_assign`) 
            VALUES ('".$_GET['patient_id']."','".$_SESSION['admin_id']."','".$_GET['room']."','".$date."');";
        ...
        case "fix":
            ...
            if (mysqli_query($conn, $sql)){
                //Thông báo nếu thành công
                $sql = "INSERT INTO `patient_room`(`patient_id`, `room`, `date_room`) 
                VALUES ('".$_GET['patient_id']."','".$_GET['room']."','".$date."');";
                if (mysqli_query($conn, $sql)){
                    //Thông báo nếu thành công
                    echo 'Thêm thành công';
                    echo "<script>alert('Add employee successfully')</script>";
