...
<body>
        ...
        <div class="content-body">
			...
			<div class="container-fluid">
				<div class="form-head d-flex page-titles mb-sm-4 mb-3 align-items-center">
					...
					<a href="app-profile.php" class="btn btn-outline-primary">Update Profile</a>
				</div>
				<div class="row">
						...
						<div class="row">
							<div class="col-xl-12">
								<div class="card doctor-details-card">
									<div class="bg-img-bx">
										<img src="images/bg2.jpg" alt="" class="bg-img">
										<a href="doctor.php" class="btn btn-primary"><i class="las la-stethoscope mr-3 scale5"></i>Dentist Specialist</a>
									</div>
									<div class="card-body">
								...
								<div class="card recent-review">
									...
									<div class="card-body">
										<div class="media p-3 border">
											<img src="images/users/1.jpg" alt="" class="mr-sm-4 mr-3">
											<div class="media-body row align-items-center">
												<div class="col-md-8 mb-md-0 mb-3">
													<h4><a href="reviews.php" class="text-black fs-20">Glee Smiley</a></h4>
										...
										<div class="media p-3 border">
											<img src="images/users/2.jpg" alt="" class="mr-sm-4 mr-3">
											<div class="media-body row align-items-center">
												<div class="col-md-8 mb-md-0 mb-3">
													<h4><a href="reviews.php" class="text-black fs-20">Emilian Brownlee</a></h4>
										...
										<div class="media p-3 border">
											<img src="images/users/3.jpg" alt="" class="mr-sm-4 mr-3">
											<div class="media-body row align-items-center">
												<div class="col-md-8 mb-md-0 mb-3">
													<h4><a href="reviews.php" class="text-black fs-20">Stevani Anderson</a></h4>
								...
								<div class="card patient-list">
									...
									<div class="card-body">
										<div class="d-flex mb-4">
											...
											<div>
												<h5 class="mb-1"><a href="patient.php" class="fs-18 text-black">Samuel  Hawkins</a></h5>
										...
										<div class="d-flex mb-4">
											...
											<div>
												<h5 class="mb-1"><a href="patient.php" class="fs-18 text-black">Debora Saragih</a></h5>
										...
										<div class="d-flex  mb-4">
											...
											<div>
												<h5 class="mb-1"><a href="patient.php" class="fs-18 text-black">Richard Kean</a></h5>
										...
										<div class="d-flex">
											...
											<div>
												<h5 class="mb-1"><a href="patient.php" class="fs-18 text-black">Kevin Ash</a></h5>
												<span class="fs-14 text-primary font-w600">Dental Care</span>
											</div>
										</div>
									</div>
									<div class="card-footer pt-0 border-0">
										<a href="patient.php" class="btn d-block btn-outline-primary">+Assign New Patient</a>
									</div>
								</div>
							</div>
						</div>
    ...
    ***********************************-->
	...
	<!-- Dashboard 1 -->
	<script src="./js/dashboard/doctor-details.js"></script>
	<script>
		$(function () {
